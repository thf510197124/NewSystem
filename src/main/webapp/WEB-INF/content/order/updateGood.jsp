...
<%@ page import="com.taiquan.domain.order.goods.*" %>
...
%>
<c:if test="${ban != null}">
    <div class="container tab-pane active" id="update-ban" >
        <h5 class="text-success text-center">添加/更新不锈钢板、卷、带</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/updateGood/updateBan.html" modelAttribute="ban" method="post">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:select path="textureType" class="form-control" id="plain-texture">
                            <c:forEach var="entry" items="<%=TextureType.values()%>">
                                <form:option value="${entry.name()}" id="${entry.density}">${entry.name}</form:option>
                            </c:forEach>
                        </form:select>
                        <form:input type="text" class="form-control" path="banId" value="${ban.banId}" hidden="hidden" id="up-id"/>
                    </div>
                </div>
                ...
                <div class="col-lg-225 col-md-225 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:input path="length" id="plain-length" class="form-control"/>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 name-tip">
                    <div class="input-group">
                        <span class="input-group-addon">供应商</span>
                        <form:input path="supplierName"  class="form-control supplier" id="<%=basePath%>"/>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="修改" class="form-control btn-primary" id="add-ban-btn">
                    </div>
                </div>
            </div>
        </form:form>
...
<c:if test="${guan != null}">
    <div class="container tab-pane active" id="update-guan" >
        <h5 class="text-success text-center">添加/更新不锈钢管</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/updateGood/updateGuan.html" modelAttribute="guan" method="post">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:select path="textureType" class="form-control" id="guan-texture">
                            <c:forEach var="entry" items="<%=TextureType.values()%>">
                                <form:option value="${entry.name()}" id="${entry.density}">${entry.name}</form:option>
                            </c:forEach>
                        </form:select>
                    </div>
                    <form:input type="text" class="form-control" path="guanId" value="${guan.guanId}" hidden="hidden" id="up-id"/>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-guan-btn">
                    </div>
                </div>
            </div>
        </form:form>
...
<c:if test="${xing != null}" >
    <div class="container tab-pane active" id="update-xing" >
        <h5 class="text-success text-center">添加/更新不锈钢型材</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/updateGood/updateXing.html" modelAttribute="xing" method="post">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:select path="textureType" class="form-control" id="xing-texture">
                            <c:forEach var="entry" items="<%=TextureType.values()%>">
                                <form:option value="${entry.name()}" id="${entry.density}">${entry.name}</form:option>
                            </c:forEach>
                        </form:select>
                        <form:input type="text" class="form-control" path="xingId" value="${xing.xingId}" hidden="hidden" id="up-id"/>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-7 col-xs-7 name-tip">
                    <div class="input-group">
                        <span class="input-group-addon">供应商</span>
                        <form:input path="supplierName"  class="form-control supplier" id="<%=basePath%>"/>
                    </div>
                ...
                <div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-xing-btn" >
                    </div>
                </div>
            </div>
        </form:form>
...
<c:if test="${ling != null}">
    <div class="container tab-pane active" id="update-ling" >
        <h5 class="text-success text-center">添加/更新不锈钢零部件</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/updateGood/updateLing.html" modelAttribute="ling" method="post">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:select path="textureType" class="form-control" id="ling-texture">
                            <c:forEach var="entry" items="<%=TextureType.values()%>">
                                <form:option value="${entry.name()}">${entry.name}</form:option>
                            </c:forEach>
                        </form:select>
                        <form:input type="text" class="form-control" path="lingId" value="${ling.lingId}" hidden="hidden" id="up-id"/>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">规格</span>
                        <form:input path="spec" class="form-control " oninvalid="validatelt(this,'只能输入数字')" id="ling-spec" />
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-ling-btn" >
                    </div>
                </div>
            </div>
        </form:form>
...
<c:if test="${jia != null}">
    <div class="container tab-pane active" id="update-jia" >
        <h5 class="text-success text-center">添加/更新不锈钢加工</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/updateGood/updateJia.html" modelAttribute="jia" method="post">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                    ...
                    <form:input type="text" class="form-control" path="jiaId" value="${jia.jiaId}" hidden="hidden" id="up-id"/>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">数量</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-jia-btn">
                    </div>
                </div>
            </div>
        </form:form>
...
<c:if test="${other != null}">
    <div class="container tab-pane active" id="update-others" >
        <h5 class="text-success text-center">添加/更新其他产品</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/updateGood/updateOther.html" modelAttribute="other" method="post">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:input type="text" class="form-control" path="otherId" value="${other.otherId}" hidden="hidden" id="up-id"/>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-others-btn">
                    </div>
                </div>
            </div>
        </form:form>
