...
%>
<c:if test="${ban != null}">
    <div class="update-good-ban" >
        <h4 class="text-info">更新不锈钢板、卷、带</h4>
        <hr/>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
                    <div class="input-group">
                        ...
                        <form:input path="supplierName"  class="form-control supplier" />
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
                    <div class="input-group">
...
<c:if test="${guan != null}">
    <div class="update-good-guan" >
    <h4 class="text-info">更新不锈钢管</h4>
    <hr/>
...
<c:if test="${xing != null}">
    <div class="update-good-xing" >
    <h4 class="text-info">更新不锈钢型材</h4>
    <hr/>
...
<c:if test="${ling != null}">
    <div class="update-good-ling" >
    <h4 class="text-info">更新不锈钢零部件</h4>
    <hr/>
...
<c:if test="${jia != null}">
    <div class="update-good-jia" >
    <h4 class="text-info">更新不锈钢加工</h4>
    <hr/>
...
<c:if test="${other != null}">
    <div class="update-good-other" >
    <h4 class="text-info">更新其他产品</h4>
    <hr/>
