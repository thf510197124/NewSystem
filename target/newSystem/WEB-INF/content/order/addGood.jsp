...
%>
<div class="container tab-pane active" id="add-ban">
    <div class="add-good-ban" >
        <h5 class="text-success text-center">添加不锈钢板、卷、带</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/addOrder/addBan.html" modelAttribute="banBean" method="post">
            <div class="row">
                <div class="col-lg-24 col-md-24 col-sm-6 col-xs-6 ">
                ...
                <div class="col-lg-24 col-md-24 col-sm-3 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">厚度(mm)</span>
                        <form:input path="thick" type="number" step="0.01" id="plain-thick" class="form-control required" oninvalid="validatelt(this,'只能输入数字')" />
                    </div>
                </div>
                <div class="col-lg-24 col-md-24 col-sm-3 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">公差(mm)</span>
                        <form:input path="realThick" type="number" step="0.01" class="form-control" id="plain-realThick" oninvalid="validatelt(this,'只能输入数字')"/>
                    </div>
                </div>
                <div class="col-lg-24 col-md-24 col-sm-6 col-xs-6 ">
                    <div class="input-group">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:input path="banAmount" type="number" class="form-control good-amount required" oninvalid="validatelt(this,'只能输入数字')" id="plain-amount"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-ban-btn" disabled="disabled">
                    </div>
                </div>
            </div>
        </form:form>
...
<div class="container tab-pane" id="add-guan">
    <div class="add-good-guan" >
        <h5 class="text-success text-center">添加不锈钢管</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/addOrder/addGuan.html" modelAttribute="guanBean" method="post">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:input path="spec" class="form-control required"  id="guan-spec"/>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">数量</span>
                        <form:input path="amount" type="number" class="form-control good-amount required" oninvalid="validatelt(this,'只能输入数字')" id="guan-amount"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-guan-btn" disabled="disabled">
                    </div>
                </div>
            </div>
        </form:form>
...
<div class="container tab-pane" id="add-xing">
    <div class="add-good-xing" >
        <h5 class="text-success text-center">添加不锈钢型材</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/addOrder/addXing.html" modelAttribute="xingBean" method="post">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        ...
                        <form:input path="spec" class="form-control required" oninvalid="validatelt(this,'只能输入数字')" list="cao-list" id="xing-spec"/>
                    </div>
                    <datalist id="cao-list">
                        <c:forEach var="entry" items="<%=CaogangType.values()%>">
                            <option value="${entry.name}" id="${entry.weight}">${entry.name}</option>
                        </c:forEach>
                    </datalist>
                    <datalist id="gong-list">
                        <c:forEach var="entry" items="<%=GongZiType.values()%>">
                            <option value="${entry.name}" id="${entry.weight}">value="${entry.name}"</option>
                        </c:forEach>
                    </datalist>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">数量</span>
                        <form:input path="amount" type="number" class="form-control good-amount required" oninvalid="validatelt(this,'只能输入数字')" id="xing-amount"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-xing-btn" disabled="disabled">
                    </div>
                </div>
            </div>
        </form:form>
...
<div class="container tab-pane" id="add-ling">
    <div class="add-good-ling" >
        <h5 class="text-success text-center">添加不锈钢零部件</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/addOrder/addLing.html" modelAttribute="lingBean" method="post">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">规格</span>
                        <form:input path="spec" class="form-control required" oninvalid="validatelt(this,'只能输入数字')" id="ling-spec"/>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">数量</span>
                        <form:input path="amount" type="number" class="form-control good-amount required" oninvalid="validatelt(this,'只能输入数字')" id="ling-amount"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-ling-btn" disabled="disabled">
                    </div>
                </div>
            </div>
        </form:form>
...
<div class="container tab-pane" id="add-jia">
    <div class="add-good-jia" >
        <h5 class="text-success text-center">添加不锈钢加工</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/addOrder/addJiaGong.html" modelAttribute="jiaGongBean" method="post">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">数量</span>
                        <form:input path="amount" type="number" class="form-control good-amount required" oninvalid="validatelt(this,'只能输入数字')" id="jiagong-amount"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-jia-btn" disabled="disabled">
                    </div>
                </div>
            </div>
        </form:form>
...
<div class="container tab-pane" id="add-others">
    <div class="add-good-other" >
        <h5 class="text-success text-center">其他产品</h5>
        <hr/>
        <h6 class="text-danger">红色背景必填</h6>
        <hr/>
        <form:form action="${basePath}order/addOrder/addOtherServic.html" modelAttribute="otherServicBean" method="post">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                    <div class="input-group">
                        <span class="input-group-addon">数量</span>
                        <form:input path="amount" type="number" class="form-control good-amount required" oninvalid="validatelt(this,'只能输入数字')" id="other-amount"/>
                        <form:select path="amountUnit" class="form-control">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div class="input-group">
                        <input type="submit" value="添加" class="form-control btn-primary" id="add-others-btn" disabled="disabled">
                    </div>
                </div>
            </div>
        </form:form>
